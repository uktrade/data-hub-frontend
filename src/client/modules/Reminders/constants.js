...
export const TASK_AMENDMENTS_BY_OTHERS = 'task-amendments-by-others'
...
export const TASK_AMENDMENTS_BY_OTHERS_LABEL = 'Task amendments by others'
...
export const REMINDERS_SETTINGS = [
  ...
  {
    id: TASK_AMENDMENTS_BY_OTHERS,
    label: TASK_AMENDMENTS_BY_OTHERS_LABEL,
    settingsQSParam: snakeCase(TASK_AMENDMENTS_BY_OTHERS),
...
export const reminderTypeToLabel = {
  ...
  [TASK_AMENDMENTS_BY_OTHERS]: TASK_AMENDMENTS_BY_OTHERS_LABEL,
