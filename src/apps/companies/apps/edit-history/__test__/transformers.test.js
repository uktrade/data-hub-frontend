      ...
      transformCompanyAuditLog([
        {
          ...
          changes: {
            archived: [false, true],
            archived_on: [null, '2019-12-10T18:07:27.974000Z'],
            archived_reason: [null, 'Company is dissolved'],
            archived_by: [null, 'Paul Gain'],
          },
        },
      ])
    ).to.deep.equal([
      ...
      transformCompanyAuditLog([
        {
          ...
          changes: {
            archived: [true, false],
            archived_on: ['2019-12-10T18:07:27.974000Z', null],
            archived_reason: ['Company is dissolved', ''],
            archived_by: ['Paul Gain', null],
          },
        },
      ])
    ).to.deep.equal([
      ...
      transformCompanyAuditLog([
        {
          ...
          changes: {
            ...
            address_town: ['Brentwood', 'London'],
            address_county: ['Essex', 'Greater London'],
            address_postcode: ['CM14 4LQ', 'SW1H 9AJ'],
          },
        },
      ])
    ).to.deep.equal([
      ...
      transformCompanyAuditLog([
        {
          ...
          comment: '',
          changes: {
            sector: ['Biotechnology and Pharmaceuticals', 'Airports'],
            description: [null, 'Superior editing services'],
            uk_region: ['South East', 'London'],
          },
        },
      ])
    ).to.deep.equal([
      ...
      transformCompanyAuditLog([
        {
          ...
          comment: '',
          changes: {
            trading_names: [[], ['Edit History Enterprises']],
          },
        },
      ])
    ).to.deep.equal([
