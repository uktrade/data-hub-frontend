...
const { getInvestmentFilters, getInvestmentProjectsCollection } = require('./middleware/collection')
...
router.get('/', getInvestmentFilters, getInvestmentProjectsCollection, renderInvestmentList)
