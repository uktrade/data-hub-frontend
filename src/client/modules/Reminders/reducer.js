...
export default (state = initialState, { type, result, payload }) => {
  switch (type) {
    ...
    case REMINDERS__TASK_AMENDMENTS_BY_OTHERS_REMINDERS_LOADED:
    ...
    case REMINDERS__TASK_AMENDMENTS_BY_OTHERS_REMINDERS_DELETED:
    ...
    case REMINDERS__TASK_AMENDMENTS_BY_OTHERS_REMINDERS_GOT_NEXT:
