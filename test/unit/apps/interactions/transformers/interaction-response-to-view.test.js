  ...
  context('when provided a fully populated interaction', () => {
    ...
    it('should transform to display format', () => {
      expect(this.transformed).to.deep.equal({
        ...
        'Subject': 'ad',
        'Notes': 'Labore<br/>culpa<br/>quas<br/>cupiditate<br/>voluptatibus<br/>magni.',
        'Policy area': 'Access to Public Funding (inc. EU funding)',
        'Policy feedback notes': 'Labore<br/>culpa<br/>quas<br/>cupiditate<br/>voluptatibus<br/>magni.',
