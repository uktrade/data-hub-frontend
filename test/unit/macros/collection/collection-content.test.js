...
describe('Collection macro', () => {
  it('should render results summary component', () => {
    ...
    expect(component.querySelector('.c-collection__result-count').parentNode.textContent.trim()).match(/0[ \n]results/)
  })
  ...
  it('should render results summary component with correct count', () => {
    ...
    expect(component.querySelector('.c-collection__result-count').parentNode.textContent.trim()).match(/10[ \n]cats/)
  })
