...
describe('Investment team details controller', () => {
  beforeEach(() => {
    ...
    this.transformProjectManagementForViewStub = sinon
      .stub()
      .returns(this.projectManagementData)
    this.transformClientRelationshipManagementForViewStub = sinon
      .stub()
      .returns(this.clientRelationshipManagementData)
    this.transformTeamMembersForViewStub = sinon
      .stub()
      .returns(this.teamMembersData)
    ...
    this.controller.getDetailsHandler(
      this.reqStub,
      {
        ...
        render: (template, options) => {
          expect(this.transformProjectManagementForViewStub).to.be.calledWith(
            data
          )
          expect(options.projectManagementData).to.deep.equal(
    ...
    this.controller.getDetailsHandler(
      this.reqStub,
      {
        ...
        render: (template, options) => {
          expect(
            this.transformClientRelationshipManagementForViewStub
          ).to.be.calledWith(data)
          expect(options.clientRelationshipManagementData).to.deep.equal(
            this.clientRelationshipManagementData
          )
          done()
        },
      },
  ...
  it('should return labels for the project management table', (done) => {
    this.controller.getDetailsHandler(
      this.reqStub,
      {
        ...
        breadcrumb: this.breadcrumbStub,
        render: (template, options) => {
          expect(options.projectManagementLabels).to.deep.equal(
            projectManagementLabels
          )
          done()
        },
  ...
  it('should return labels for the client relationship management table', (done) => {
    this.controller.getDetailsHandler(
      this.reqStub,
      {
        ...
        breadcrumb: this.breadcrumbStub,
        render: (template, options) => {
          expect(options.clientRelationshipManagementLabels).to.deep.equal(
            clientRelationshipManagementLabels
          )
          done()
        },
