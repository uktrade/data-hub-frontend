const contact = require('../../../fixtures/v4/contact/contact.json')
const contactById = require('../../../fixtures/v4/contact/contact-by-id.json')
const contactByIdWithNoDocument = require('../../../fixtures/v4/contact/contact-by-id-with-no-document.json')
const contactsForReferral = require('../../../fixtures/v4/contact/contacts-for-referral.json')

const lambdaPlc = require('../../../fixtures/v4/company/company-lambda-plc.json')
const contactCreate = require('../../../fixtures/v4/contact/contact-create.json')
