  ...
  context('With the feature flag is true', () => {
    ...
    context('When the theme is export or other', () => {
      context('When there is an interaction', () => {
        it('returns false', () => {
          expect(
            canAddCountries(THEMES.EXPORT, generateInteraction(), flags)
          ).to.equal(false)
          expect(
            canAddCountries(THEMES.OTHER, generateInteraction(), flags)
          ).to.equal(false)
        })
      })
      ...
      context('When there is NOT an interaction', () => {
        it('returns true', () => {
          expect(canAddCountries(THEMES.EXPORT, undefined, flags)).to.equal(
            true
          )
    ...
    context('When the theme is something else', () => {
      context('When there is an interaction', () => {
        it('returns false', () => {
          expect(
            canAddCountries(THEMES.INVESTMENT, generateInteraction(), flags)
          ).to.equal(false)
          expect(
            canAddCountries('test', generateInteraction(), flags)
          ).to.equal(false)
        })
      })
      ...
      context('When there is NOT an interaction', () => {
        it('returns false', () => {
          expect(canAddCountries(THEMES.INVESTMENT, undefined, flags)).to.equal(
            false
          )
    ...
    context('When the theme is export or other', () => {
      ...
      context('When there is NOT an interaction', () => {
        it('returns false', () => {
          ...
          expect(canAddCountries(THEMES.OTHER, undefined, flags)).to.equal(
            false
          )
        })
      })
