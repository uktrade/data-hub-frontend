...
function Routes() {
  const routes = useRoutes([
    ...
    },
    {
      ...
      element: (
        <ProtectedRoute module={'datahub:companies'} test123={Success} />
      ),
    },
    {
    ...
    },
    {
      ...
      element: (
        <ProtectedRoute module={'datahub:companies'} test123={EditSuccess} />
      ),
    },
    {
    ...
    },
    {
      ...
      element: (
        <ProtectedRoute
          module={'datahub:investments'}
          test123={AddPropositionDocument}
        />
      ),
    },
    {
