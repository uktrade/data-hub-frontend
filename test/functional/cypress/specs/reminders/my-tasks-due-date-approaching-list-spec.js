...
import {
  myTasksDueDateApproachingReminderFaker,
  reminderListFaker,
...
describe('My Tasks Due Date Approaching Reminders', () => {
  ...
  const reminders = [
    ...
    ...reminderListFaker(9, myTasksDueDateApproachingReminderFaker),
  ]
  const nextReminder = myTasksDueDateApproachingReminderFaker()
  const totalCount = 25
  ...
  const interceptApiCalls = () => {
    ...
    cy.intercept(
      ...
      },
      {
        body: {
          count: totalCount,
          results: reminderListFaker(5, myTasksDueDateApproachingReminderFaker),
          next: null,
          previous: null,
        },
      }
