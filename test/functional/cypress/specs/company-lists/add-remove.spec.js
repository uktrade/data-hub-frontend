...
describe('Adding and removing a company to a list', () => {
  context('when viewing the companies page with company lists created', () => {
    ...
    it('displays a button to add or remove from a list', () => {
      cy.get(listSelectors.addRemoveButton).should('have.text', 'Add to or remove from lists')
    })
  })
  context('when viewing the add/remove from lists form', () => {
    ...
    it('should render options for list B', () => {
      cy.get(listSelectors.listB.legend).should('have.text', 'On the "List B" list')
    ...
    it('should render options for list B', () => {
      cy.get(listSelectors.listC.legend).should('have.text', 'On the "List C" list')
    ...
    it('should render a "Create list" button', () => {
      cy.get(listSelectors.createButton).should('have.text', 'Create a new list')
    })
