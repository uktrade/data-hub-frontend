  ...
  if (!interactionId) {
    if (wasPolicyFeedbackProvided) {
      const body = [
        ...
        '',
        'For more on the value of BI, <a href="https://workspace.trade.gov.uk/working-at-dit/policies-and-guidance/business-intelligence-reports/" target="_blank" aria-label="Opens in a new window or tab"\n>See the Digital Workspace article</a> (opens in new tab)',
      ].join('<br />')
