      ...
      <>
        <Container>
          ...
          <ListContainer>
            ...
            {reminderType === TASK_AMENDMENTS_BY_OTHERS && (
              <TaskAmendmentsByOthersList />
            )}
