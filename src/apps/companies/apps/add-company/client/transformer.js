...
const POSTCODE_AREA_TO_REGION = {
  ...
  BR: UK_REGIONS.SOUTH_EAST, // Bronmley
  ...
  DN: UK_REGIONS.YORKSHIRE_AND_THE_HUMBER, // Donaster
...
export const mapPostcodeToRegion = (postcode) => {
  // The shortest UK postcode is five characters (without spaces)
  if (
    postcode?.length < 5 ||
    postcode === undefined ||
