...
describe('#formatHelpCentreAnnouncements', () => {
  const mockData = {
    ...
    articles: [
      ...
      },
      {
        ...
        name: 'Recording multiple DBT advisers against interactions',
        title: 'Recording multiple DBT advisers against interactions',
  ...
  const expected = [
    ...
    {
      heading: 'Recording multiple DBT advisers against interactions',
