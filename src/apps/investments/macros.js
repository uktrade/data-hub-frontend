  ...
  return {
    ...
    children: [
      ...
      },
      {
        ...
        inputData: {
          cy: 'field-client_considering_other_countries',
        },
        options: [
