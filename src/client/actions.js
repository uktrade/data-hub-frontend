...
export const DATA_SUMMARY_PICKER__RANGE_SELECTED =
  'DATA_SUMMARY_PICKER__RANGE_SELECTED'
export const DATA_SUMMARY_PICKER__ACCESSIBLE_TOGGLE =
...
export const VALIDATED_FORM__FIELD_CHANGE = 'VALIDATED_FORM__FIELD_CHANGE'
export const VALIDATED_FORM__NEXT = 'VALIDATED_FORM__NEXT'
export const VALIDATED_FORM__BACK = 'VALIDATED_FORM__BACK'

export const RADIOS_FIELD__SET_VALUE = 'RADIOS_FIELD__SET_VALUE'
export const SELECT_FIELD__SET_VALUE = 'SELECT_FIELD__SET_VALUE'
