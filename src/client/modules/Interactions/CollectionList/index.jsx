...
import {
  LABELS,
  KIND_OPTIONS,
  ACTIVITY_OPTIONS as ACTIVITY_OPTIONS,
...
`
function companyAddToCollectionListTaskPayload(company, collectionListTask) {
  if (company) {
    collectionListTask.startOnRender.payload.company = [company.id]
  }
}
...
const InteractionCollection = ({
  ...
  companyAddToCollectionListTaskPayload(company, collectionListTask)
  ...
  const filteredCollectionList = (
    ...
    >
      <CollectionFilters taskProps={collectionListMetadataTask}>
        ...
        />
        <StyledCheckboxGroup
          legend={LABELS.activity}
          name="activity"
          qsParam="activity"
          options={ACTIVITY_OPTIONS}
          selectedOptions={selectedFilters.activity.options}
