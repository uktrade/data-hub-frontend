...
export const TASK_GET_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDERS =
  'TASK_GET_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDERS'
export const TASK_DELETE_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDER =
  'TASK_DELETE_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDER'
export const TASK_GET_NEXT_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDER =
  'TASK_GET_NEXT_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDER'

export const TASK_GET_TASK_AMENDED_BY_OTHERS_REMINDERS =
  'TASK_GET_TASK_AMENDED_BY_OTHERS_REMINDERS'
export const TASK_DELETE_TASK_AMENDED_BY_OTHERS_REMINDER =
  'TASK_DELETE_TASK_AMENDED_BY_OTHERS_REMINDER'
export const TASK_GET_NEXT_TASK_AMENDED_BY_OTHERS_REMINDER =
  'TASK_GET_NEXT_TASK_AMENDED_BY_OTHERS_REMINDER'

export const TASK_GET_TASK_OVERDUE_REMINDERS = 'TASK_GET_TASK_OVERDUE_REMINDERS'
export const TASK_DELETE_TASK_OVERDUE_REMINDER =
  'TASK_DELETE_TASK_OVERDUE_REMINDER'
export const TASK_GET_NEXT_TASK_OVERDUE_REMINDER =
  'TASK_GET_NEXT_TASK_OVERDUE_REMINDER'

export const TASK_GET_TASK_COMPLETED_REMINDERS =
  'TASK_GET_TASK_COMPLETED_REMINDERS'
export const TASK_DELETE_TASK_COMPLETED_REMINDER =
  'TASK_DELETE_TASK_COMPLETED_REMINDER'
export const TASK_GET_NEXT_TASK_COMPLETED_REMINDER =
...
export const TASK_SAVE_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDER_SUBSCRIPTIONS =
  'TASK_SAVE_TASK_ASSIGNED_TO_ME_FROM_OTHERS_REMINDER_SUBSCRIPTIONS'
export const TASK_SAVE_TASK_AMENDED_BY_OTHERS_REMINDER_SUBSCRIPTIONS =
  'TASK_SAVE_TASK_AMENDED_BY_OTHERS_REMINDER_SUBSCRIPTIONS'
export const TASK_SAVE_OVERDUE_REMINDER_SUBSCRIPTIONS =
  'TASK_SAVE_OVERDUE_REMINDER_SUBSCRIPTIONS'
export const TASK_SAVE_COMPLETED_REMINDER_SUBSCRIPTIONS =
