...
describe('Event create', () => {
  ...
  it('should allow user to add multiple programmes', () => {
    ...
    cy.get(selectors.eventCreate.relatedProgrammes).eq(0).should('contain', 'CEN Energy')
    cy.get(selectors.eventCreate.relatedProgrammes).eq(1).should('contain', 'Services')
  })
})
