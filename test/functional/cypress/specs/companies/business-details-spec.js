  ...
  context('when viewing business details for a Dun & Bradstreet company not on the One List', () => {
    ...
    it('should display the "About" details', () => {
      assertKeyValueTable('aboutDetails', {
        ...
        'Annual turnover': '£750,148.00This is an estimated numberWhat does that mean?This information is not available for this business. The number has been modelled by Dun & Bradstreet, based on similar businesses.',
        'Number of employees': '95This is an estimated numberWhat does that mean?This information is not available for this business. The number has been modelled by Dun & Bradstreet, based on similar businesses.',
        'Website': 'Not set',
      })
    })
