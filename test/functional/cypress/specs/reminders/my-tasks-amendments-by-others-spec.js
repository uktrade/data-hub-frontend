...
const remindersEndpoint = '/api-proxy/v4/reminder/my-tasks-amendments-by-others'

describe('My Tasks Task amendments by others Reminders', () => {
  after(() => {
    cy.resetUser()
  })
  ...
  context('Reminders List', () => {
    before(() => {
      interceptApiCalls()
      cy.visit(urls.reminders.myTasks.taskAmendmentsByOthers())
    ...
    it('should render breadcrumbs', () => {
      assertBreadcrumbs({
        ...
        'Task amendments by others': null,
      })
    })
