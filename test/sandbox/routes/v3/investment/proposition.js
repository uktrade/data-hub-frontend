import proposition from '../../../fixtures/v3/investment/proposition.json' assert { type: 'json' }
import propositionEvidence from '../../../fixtures/v3/investment/proposition-evidence.json' assert { type: 'json' }
import propositionUploadEvidence from '../../../fixtures/v3/investment/proposition-upload-evidence.json' assert { type: 'json' }
