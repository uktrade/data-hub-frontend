...
describe('Company interactions controller', function () {
  ...
  beforeEach(function () {
    ...
    companyinteractioncontroller = proxyquire('~/src/apps/companies/controllers/interactions', {
      '../services/data': {
  ...
  describe('markup', function () {
    ...
    it('should warn the user if there are no interactions and no contacts to associate with interactions', function () {
      company.contacts = []
      return render('../../src/apps/companies/views/interactions.njk', { interactions: [], addInteractionUrl, company, addContact: 'test' })
      .then((document) => {
    ...
    it('should render a list of interactions', function () {
      return render('../../src/apps/companies/views/interactions.njk', { interactions, addInteractionUrl, company })
      .then((document) => {
