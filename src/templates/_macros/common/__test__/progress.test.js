...
describe('Progress component', () => {
  ...
  it('should render stages as expected', () => {
    ...
    expect(progressStageLiElems[1].firstElementChild.textContent).to.contain(
      'two'
    )
    expect(progressStageLiElems[2].firstElementChild.textContent).to.contain(
      'three'
    )
    expect(progressStageLiElems[3].firstElementChild.textContent).to.contain(
      'four'
    )
    expect(progressStageLiElems[4].firstElementChild.textContent).to.contain(
      'five'
    )
