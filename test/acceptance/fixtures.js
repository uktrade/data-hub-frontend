...
module.exports = {
  company: {
    ...
    dnbCorp: {
      id: 'cc7e2f19-7251-4a41-a27a-f98437720531',
      name: 'DnB Corp',
      tradingName: 'DnB\nD&B',
      ...
      postcode: '001122',
      country: 'Italy',
      primaryAddress: '1 Main Road, Rome, 001122, Italy',
      businessType: 'Company',
      globalHq: 'None',
      sector: 'Retail',
      description:
    ...
    oneListSubsidiary: {
      ...
      address1: '100 Fordham Rd',
      town: 'Hainault',
      postcode: 'IG6 7SQ',
      country: 'United Kingdom',
      primaryAddress: '100 Fordham Rd, Hainault, IG6 7SQ, United Kingdom',
      businessType: 'Company',
      ukRegion: 'London',
      headquarterType: 'Not a headquarters',
