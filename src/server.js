...
app.use(require('./controllers/companycontrollerch').router)
app.use(require('./controllers/companycontrollerforeign').router)
app.use(require('./controllers/companycontrollerltd').router)
app.use(require('./controllers/companycontrollerukother').router)
app.use(require('./controllers/companyinteractioncontroller').router)
app.use(require('./controllers/companycontactcontroller').router)
app.use(require('./controllers/companyaddcontroller').router)
app.use(require('./controllers/companyarchivecontroller').router)
app.use(companyInvestmentSummaryController.router)
app.use(companyInvestmentSummaryController.router)
app.use(contactController.router)
app.use(require('./controllers/contactarchivecontroller').router)
