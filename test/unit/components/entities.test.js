...
describe('Entities macros', () => {
    ...
    describe('valid props', () => {
      ...
      it('should render entity component with modifier', () => {
        const component = entitiesMacros.renderToDom('Entity', {
          ...
          type: 'animal',
          meta: [
            { label: 'Colour', value: 'brown', isTag: true },
            { label: 'DOB', value: '2015-11-10', name: 'date_of_birth', isTag: false },
          ],
        })

        expect(component.querySelector('.c-entity__header .c-entity__tags')).to.exist
  ...
  describe('MetaItem macro', () => {
    ...
    describe('valid props', () => {
      ...
      it('should render metadata as tag', () => {
        const component = entitiesMacros.renderToDom('MetaItem', {
          label: 'Dessert',
          value,
          isTag: true,
        ...
        expect(component.querySelector('.c-tag')).to.exist
      })
