...
describe('#transformInteractionResponseToForm', () => {
  ...
  context(
    'when the source is a service delivery and optional fields have been selected',
    () => {
      beforeEach(() => {
  ...
  context(
    'when the source is a service delivery and optional fields have been unselected',
    () => {
      beforeEach(() => {
        const interaction = {
          ...mockInteraction,
  ...
  context(
    'when the source is a service delivery and has no policy feedback',
    () => {
      ...
      beforeEach(() => {
        this.transformed = transformInteractionResponseToForm(
          mockInteractionNoFeedback
        )
      })
      it('should transform data from interaction response to form', () => {
        expect(this.transformed).to.deep.equal({
