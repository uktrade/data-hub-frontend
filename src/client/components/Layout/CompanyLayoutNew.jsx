...
import { CompanyLocalHeader } from '../../components'
...
const CompanyLayoutNew = ({ children, pageTitle, breadcrumbs, companyId }) => {
  ...
  return (
    <>
      ...
      <CompanyLocalHeader breadcrumbs={breadcrumbs} companyId={companyId} />
